...
import styles from './HeroContrast.module.css';

gsap.registerPlugin(ScrollTrigger);

export default function HeroContrast() {
    ...
    <div className={styles.hero} ref={containerRef}>
      ...
      <div className={styles.titleContainer} ref={titleRef}>
        <div ref={titleInnerRef}>
          <h1 className={styles.title}>Intouchables<br/>& Literatura</h1>
          <p className={styles.subtitle}>Apreciación del Arte — Película, clase y escritura</p>
        </div>
      </div>

      <div className={`${styles.stratum} ${styles.layer1} stratum-layer`}>
        <div className={styles.stratumContent}>
          <span className={styles.stratumLabel}>ESCENA I: LOS MUNDOS</span>
          Distrito 7 de París y La Banlieue
        </div>
      </div>
      
      <div className={`${styles.stratum} ${styles.layer2} stratum-layer`}>
        <div className={styles.stratumContent}>
          <span className={styles.stratumLabel}>ESCENA II: LA MIRADA</span>
          Códigos culturales y prejuicio.
        </div>
      </div>
      
      <div className={`${styles.stratum} ${styles.layer3} stratum-layer`}>
        <div className={styles.stratumContent}>
          <span className={styles.stratumLabel}>LITERATURA: ERNAUX</span>
      ...
      <div className={`${styles.stratum} ${styles.layer4} stratum-layer`}>
        <div className={styles.stratumContent}>
          <span className={styles.stratumLabel}>LITERATURA: CAMUS</span>
          "Aujourd'hui, maman est morte..." — A. Camus
        </div>
      </div>
